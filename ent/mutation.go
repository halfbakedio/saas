...
func (m *UserMutation) AddTenantIDs(ids ...int) {
	if m.tenant == nil {
...
// ClearTenant clears the "tenant" edge to the Organization entity.
func (m *UserMutation) ClearTenant() {
	m.clearedtenant = true
}

// TenantCleared reports if the "tenant" edge to the Organization entity was cleared.
func (m *UserMutation) TenantCleared() bool {
	return m.clearedtenant
}

// RemoveTenantIDs removes the "tenant" edge to the Organization entity by IDs.
func (m *UserMutation) RemoveTenantIDs(ids ...int) {
...
// RemovedTenant returns the removed IDs of the "tenant" edge to the Organization entity.
func (m *UserMutation) RemovedTenantIDs() (ids []int) {
